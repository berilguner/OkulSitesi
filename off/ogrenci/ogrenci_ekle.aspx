<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ogrenci_ekle.aspx.cs" Inherits="off.ogrenci.ogrenci_ekle" %>
                ...
                <div class="col-lg-12">
                     <form id="form2" runat="server">
                         <h3>Öğrenci Ekle</h3>
                          ...
                          <div class="form-group">
                                <label for="txtOgrenciAdi">Öğrenci Adı Soyadı</label>
                                <asp:TextBox runat="server" ID="txtOgrenciAdi" CssClass="form-control" placeholder="Adı giriniz..." />
                          </div>
