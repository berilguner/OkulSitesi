<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="universite_ekle.aspx.cs" Inherits="off.universite.universite_ekle" %>
                     ...
                     <form id="form2" runat="server">
                         <h3>Üniversite Ekle</h3>
                          <div class="form-group">
                                ...
                                <a class="btn btn-danger" href="/universie/universite_listesi.aspx">İptal</a> <!--asp yapmamiza gerek yok cunku arka tarafta veritabanıyla bir işimiz yok.-->
                     </form>
                </div>
            </div>
        </div>
