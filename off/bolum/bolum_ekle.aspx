<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bolum_ekle.aspx.cs" Inherits="off.bolum.bolum_ekle" %>
                     ...
                     <form id="form2" runat="server">
                         <h3>Bölüm Ekle</h3>
                          ...
                          <div class="form-group">
                                ...
                                <asp:TextBox runat="server" ID="txtBolumAdi" CssClass="form-control" placeholder="Bilgisayar Mühendisliği..." />
                          </div>
